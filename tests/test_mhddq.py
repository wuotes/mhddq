...
def test_oplist():
    ...
    mhddq.oplist_file_write(oplist, expect_true, r'TEST WRITE TEST DATA', r'./tests/fake_dir/fake.file')
    mhddq.oplist_file_read(oplist, expect_true_and_data, r'./tests/fake_dir/fake.file')
